...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/about/`, lastModified: "2026-04-05", changeFrequency: "monthly", priority: 0.6 },
    ...
    { url: `${baseUrl}/certifications/`, lastModified: "2026-06-16", changeFrequency: "monthly", priority: 0.6 },
