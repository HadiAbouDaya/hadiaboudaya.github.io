...
- [ ] Logos of freelance clients: TowardsChange, ShebangNow, AI.skilled, Traveln.ai, Supportful
- [ ] Screenshots or mockups of projects you built (Cyrus AI, Zameel AI, chatbots, RAG systems)
...
- [x] **aws-ai-practitioner.png** (in place as aws-ai-practitioner.webp)
...
- [ ] **ai-900.png**
- [ ] **dp-900.png**
- [ ] **tensorflow-developer.png**
- [ ] **deep-learning-specialization.png**
- [ ] **google-data-analytics.png**
- [ ] Add others as needed

### certifications/documents/
Full certificate PDFs or screenshots (for download/zoom links):
- [ ] Drop any certificate PDFs or scanned images here
...
### community/beirut-ai/
- [ ] Photos from workshops you led (SageMaker, BERT, YOLO, MLOps)
- [ ] Group photos with attendees
- [ ] Slides or poster images
- [ ] Event banners or flyers

### community/mwc-barcelona/
- [ ] Photos from MWC 2025 jury session
...
### community/events/
- [ ] Photos from Schneider Electric, Mistral, Ampere, Murex, WiDS events
- [ ] Photos of you presenting guests (e.g. Philippe Rambach at emlyon)
- [ ] Startup Weekend Support (SWS) 2024 jury photos
...
### education/emlyon/
- [ ] Campus photo or logo
- [ ] Class photo, graduation, scholarship ceremony
- [ ] Any event photos (WiDS, guest presentations)

### education/mcgill/
- [ ] Campus photo or logo
- [ ] Exchange semester memories, class, or lab photos

### education/usj-esib/
- [ ] Campus photo or logo
- [ ] Student committee (Amicale) photos
- [ ] Graduation or project demo photos

### education/school/
- [ ] Collège Saint Joseph - Zahle logo or campus
- [ ] Any school-era photos you'd like to include (optional)
...
### blog/covers/
- [ ] Default cover image for posts without a custom one (e.g. a branded geometric pattern)
- [ ] Add post-specific cover images here as you write posts, named to match the slug: `my-post-slug.jpg`

### blog/inline/
- [ ] Images referenced inside blog post content (diagrams, screenshots, illustrations)
...
Optional textures, patterns, or ambient images for page sections:
- [ ] Hero background texture or gradient map (if not fully 3D)
- [ ] Section divider patterns
- [ ] Lebanon, Paris, Montreal skyline or landmark photos (for personal touch in About/Timeline)

---

## misc/

Anything that doesn't fit elsewhere. Sort later.
...
|----------|--------|----------|
| Photos | `.jpg` or `.webp` | < 300KB after compression |
| Logos & icons | `.svg` or `.png` (transparent) | < 50KB |
| Badges | `.png` | < 100KB |
| OG previews | `.jpg` | 1200x630, < 200KB |
| Favicon | `.ico` + `.svg` | Standard sizes |
| Blog covers | `.jpg` or `.webp` | 1200x675, < 250KB |

Use [Squoosh](https://squoosh.app) or [TinyPNG](https://tinypng.com) to compress before adding.
